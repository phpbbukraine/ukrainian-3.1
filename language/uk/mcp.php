...
$lang = array_merge($lang, array(
	...
	'ADD_WARNING_EXPLAIN'	=> 'Для надсилання попередження цьому користувачеві, будь ласка, заповніть наступну форму. Використовуйте тільки звичайний текст; HTML, BBCode і інше не дозволено.',
	...
	'MARKED_NOTES_DELETED'		=> 'Усі позначені нотатки про користувача видалені.',
	...
	'NO_TOPICS_QUEUE'				=> 'Немає тем, очікуючих на схвалення.',

	'ONLY_TOPIC'			=> 'Тільки тема «%s»',
	'OTHER_USERS'			=> 'Інші користувачі, які відправляли повідомлення з цієї IP-адреси',
	...
	'PM_REPORTS_TOTAL'			=> array(
		...
		1		=> 'Всього <strong>%d</strong> скарга на приватне повідомлення.',
		2		=> 'Всього <strong>%d</strong> скарги на приватні повідомлення.',
		3		=> 'Всього <strong>%d</strong> скарг на приватні повідомлення.',
	),
	...
	'REPORTS_TOTAL'				=> array(
		1		=> 'Всього є <strong>%d</strong> скарга для перегляду.',
		2		=> 'Всього є <strong>%d</strong> скарги для перегляду.',
		3		=> 'Всього є <strong>%d</strong> скарг для перегляду.',
	),
	...
	'SEARCH_POSTS_BY_USER'				=> 'Пошук повідомлень за',
	...
	'SPLIT_TOPIC_EXPLAIN'				=> 'Використовуючи форму, подану нижче, ви можете розділити тему на дві, або шляхом вибору окремих повідомлень, або шляхом відділення після вибраного повідомлення.',
 	...
 	'THIS_PM_IP'				=> 'IP-адреса для приватного повідомлення',
	'THIS_POST_IP'				=> 'IP-адреса для повідомлення',
	...
	'UNAPPROVED_POSTS_TOTAL'		=> array(
		0		=> 'Немає повідомлень, що очікують схвалення.',
		1		=> '<strong>%d</strong> повідомлення очікує схвалення.',
		2		=> '<strong>%d</strong> повідомлення очікують схвалення.',
		3		=> '<strong>%d</strong> повідомлень очікують схвалення.',
	),
	'UNLOCK'						=> 'Відкрити',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'SPAM'		=> 'Повідомлення має єдиною метою рекламу сайтів, програм або інших продуктів, товарів, послуг і ін.',
