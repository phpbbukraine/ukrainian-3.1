...
$lang = array_merge($lang, array(
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1		=> 'Ваше повідомлення містить %1$d символ. Мінімальна кількість символів, необхідна для публікації повідомлення — %2$d.',
		2  		=> 'Ваше повідомлення містить %1$d символа. Мінімальна кількість символів, необхідна для публікації повідомлення — %2$d.',
		3  		=> 'Ваше повідомлення містить %1$d символів. Мінімальна кількість символів, необхідна для публікації повідомлення — %2$d.',
	),
	...
	'TOO_MANY_CHARS_POST'		=> array(
		2	=> 'Ваше повідомлення містить забагато символів: %1$d. Максимальна дозволена кількість: %2$d.',
	),
	'TOO_MANY_CHARS_SIG'		=> array(
		2	=> 'Ваш підпис містить занадто багато символівв: %1$d. Максимальна дозволена кількість: %2$d.',
	),
	...
	'WRONG_FILESIZE'			=> 'Завеликий розмір вкладення. <br/> Максимальний дозволений розмір: %1d %2s.',
