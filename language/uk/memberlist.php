...
$lang = array_merge($lang, array(
	...
	'IM_MSNM'				=> 'Врахуйте, що для цього вам необхідна встановлена ​​програма Windows Live Messenger.',
	'IM_MSNM_BROWSER'		=> 'Ваш браузер не підтримує цю функцію.',
	'IM_MSNM_CONNECT'		=> 'Клієнт WLM не відповідає.\nДля продовження необхідно встановити зв\'язок з клієнтом.',
	'IM_NAME'				=> 'Ваше ім\'я',
	...
	'SEND_MSNM_MESSAGE'		=> 'Надіслати WLM-повідомлення',
	...
	'USER_LAST_REMINDED'	=> array(
		...
		2		=> 'Надіслано %1$d напоминания<br />» %2$s',
