...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Ваш обліковий запис був оновлений​​. Однак на цій конференції необхідно повторне активування облікового запису адміністратором при зміні адреси email. Повідомлення email було надіслано адміністратору. Ви будете повідомлені, коли ваш обліковий запис буде повторно активована.',
