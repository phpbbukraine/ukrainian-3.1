...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Ваш обліковий запис був оновлений​​. Однак на цій конференції необхідно повторно активувати обліковий запис при зміні email адреси. Ключ для активування був відправлений на зазначений вами нову email адресу. Перевірте свою електронну пошту для отримання детальнішої інформації.',
	...
	'ACTIVATION_EMAIL_SENT'			=> 'Лист для активації облікового запису було вислано на вашу email адресу.',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> 'Листи для активації облікового запису були вислані на email адреси адміністраторів.',
	'ADD'							=> 'Добавити',
	...
	'ADD_USERS_UCP_EXPLAIN'			=> 'Тут ви можете додавати нових користувачів до групи. Ви можете вибрати, чи стане ця група групою за замовчуванням для доданих до неї користувачів. Dgbceqnt кожне ім\'я користувача на окремому рядку.',
	...
	'EMAIL_REMIND'				=> 'Адреса email, пов\'язаний з вашим обліковим записом. Якщо ви не змінили його у Ваших налаштувань, то це email адреса, зазначена вами при реєстрації.',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Введіть адресу email, використаний для реєстрації облікового запису на сайті <a href="http://www.gravatar.com/">Граватар</a>.',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> 'Введіть URL, за яким знаходиться файл із зображенням, він буде використаний у якості вашої аватари.',
