...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'		=> 'Ця політика детально пояснює, як «%1$s» і його підрозділи (надалі «ми», «наш», «%1$s», «%2$s») і phpBB (надалі «вони», «програмне забезпечення phpBB», «www.phpbb.com», «phpBB Group», «phpBB Teams») використовують інформацію, отриману під час будь-якої вашої сесії (надалі «інформація про вас»).<br />
	<br />
