...
$lang = array_merge($lang, array(
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Керувати ключами входу для функції «Запам\'ятати мене»',

	'UCP_USERGROUPS'			=> 'Групи',
	'UCP_USERGROUPS_MEMBER'		=> 'Участь у групах',
	'UCP_USERGROUPS_MANAGE'		=> 'Управління групами',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'Функція скидання пароля була відключена. Якщо вам потрібна допомога для доступу до вашого профілю, будь ласка, зв\'яжіться з %sАдміністратором конференції%s',
