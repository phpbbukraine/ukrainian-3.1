...
$lang = array_merge($lang, array(
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Значення поля «%2$s» занадто коротке, мінімально допустима довжина становить %1$d символів.',
		2	=> 'Значення поля «%2$s» занадто коротке, мінімально допустима довжина становить %1$d символів.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Значення поля «%2$s» занадто довге, максимально допустима довжина становить %1$d символів.',
		2	=> 'Значення поля «%2$s» занадто довге, максимально допустима довжина становить %1$d символів.',
	),
	...
	'FOLDER_ADDED'				=> 'Папка була успішно додана.',
		...
		1	=> '%2$d із %1$d повідомлень',
		2	=> '%2$d із %1$d повідомлень',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папка заповнена на %3$d%% (%2$d із %1$d повідомлень)',
		2	=> 'Папка заповнена на %3$d%% (%2$d із %1$d повідомлень)',
	),
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Папка з вашими приватними повідомленнями заповнена. Відкладених повідомлень: %d.',
		1	=> 'Папка з вашими приватними повідомленнями заповнена. Відкладених повідомлень: %d.',
	),
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> 'Фільтрами ПП було видалено приватних повідомлень: %d',
		2	=> 'Фільтрами ПП було видалено приватних повідомлень: %d',
	),
