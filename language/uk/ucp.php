...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'					=> 'Ваш обліковий запис було створено, але тепер вона повинна бути схвалена, більш детальна інформація була надіслана вам на email.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Ваш обліковий запис був оновлений​​. Однак на цій конференції необхідно повторно активувати обліковий запис при зміні email адреси. Ключ для активування був відправлений на вказану вами нову email адресу. Перевірте свою електронну пошту для отримання детальнішої інформації.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Ваш обліковий запис був оновлений​​. Однак на цій конференції необхідно повторне активування облікового запису адміністратором при зміні адреси email. Повідомлення на електронну пошту було надіслано адміністратору. Ви будете повідомлені, коли ваш обліковий запис буде повторно активований.',
	...
	'ACTIVATION_EMAIL_SENT'			=> 'Лист для активації облікового запису було надіслано на вашу email адресу.',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> 'Листи для активації облікового запису були надіслані на email адреси адміністраторів.',
	'ADD'							=> 'Добавити',
	...
	'ADD_USERS_UCP_EXPLAIN'			=> 'Тут ви можете додавати нових користувачів до групи. Ви можете вибрати, чи стане ця група групою за замовчуванням для доданих до неї користувачів. Вписуйте кожне ім\'я користувача на окремому рядку.',
	...
	'ALLOW_PM_EXPLAIN'				=> 'Врахуйте, що адміністратори і модератори конференції можуть завжди посилати вам повідомлення.',
	'ALREADY_ACTIVATED'				=> 'Ви вже активували свій обліковий запис.',
	'ATTACHMENTS_EXPLAIN'			=> 'Це список вкладень в повідомленнях, надісланих на цій конференції.',
	'ATTACHMENTS_DELETED'			=> 'Вкладення успішно видалені.',
	'ATTACHMENT_DELETED'			=> 'Вкладення успішно видалено.',
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Обрані ключі входу для функції «Запам\'ятати мене» успішно видалені.',
	'AVATAR_CATEGORY'				=> 'Категорія',
	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Граватар',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Граватар - служба, яка дозволяє використовувати одну й ту ж аватару на декількох сайтах. відвідайте сайт <a href="http://www.gravatar.com/">Граватар</a> для отримання додаткової інформації.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Галерея аватар',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Ви можете вибрати аватару з числа доступних у галереї на даній конференції.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Видалена аватара',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Посилання на аватару, розташовану на іншому сайті.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Завантажувана аватара',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Завантажте власну аватару.',
	'AVATAR_EXPLAIN'				=> 'Допустимі параметри: ширина не більше %1$s, висота не більше %2$s, розмір файлу не більше %3$.2f КБ.',
	...
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Неможливо завантажити аватару в %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Ваша аватара не може бути відображена, оскільки аватари заборонені.',
	'AVATAR_PAGE'					=> 'Сторінка',
	'AVATAR_SELECT'					=> 'Виберіть аватару',
	'AVATAR_TYPE'					=> 'Тип аватари',
	...
	'BOOKMARKS_DISABLED'		=> 'Закладки на цій конференції вимкнені.',
	...
	'CANNOT_MOVE_TO_SAME_FOLDER'=> 'Повідомлення не можуть бути переміщені в папку, які ви збираєтеся видалити.',
	...
	'CONFIRM_EXPLAIN'			=> 'Для запобігання автоматичних реєстрацій на конференції потрібно ввести код підтвердження. Код зображений на картинці, яка знаходиться нижче. Якщо ви не бачите код на зображенні, то зверніться до %sадміністратора%s.',
	...
	'COPPA_EXPLAIN'				=> 'Врахуйте, що ваш обліковий запис буде створено після відправки форми. Тим не менше вона не буде активована до тих пір, поки батько або опікун не схвалить вашу реєстрацію. Вам буде вислана копія email з необхідною формою і вказівками, куди її потрібно відправити.',
	...
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Ви впевнені, що хочете видалити дане вкладення?',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Ви впевнені, що хочете видалити дані вкладення?',
	'DELETE_AVATAR'				=> 'Видалити зображення',
	'DELETE_COOKIES_CONFIRM'	=> 'Ви впевнені, що хочете видалити всі cookies, встановлені даними форумом?',
	...
	'EMAIL_REMIND'				=> 'Адреса email, пов\'язаний з вашим обліковим записом. Якщо ви не змінили його у ваших налаштувань, то це email адреса, вказана вами при реєстрації.',
	...
	'FIELD_TOO_SHORT'					=> array(
		1  => 'Значення поля «%2$s» занадто коротке, мінімально допустима довжина становить %1$d символ.',
		2  => 'Значення поля «%2$s» занадто коротке, мінімально допустима довжина становить %1$d символа.',
		3  => 'Значення поля «%2$s» занадто коротке, мінімально допустима довжина становить %1$d символів.',
	),
	'FIELD_TOO_LONG'					=> array(
		1  => 'Значення поля «%2$s» занадто довга, максимально допустима довжина становить %1$d символ.',
		2  => 'Значення поля «%2$s» занадто довга, максимально допустима довжина становить %1$d символа.',
		3  => 'Значення поля «%2$s» занадто довга, максимально допустима довжина становить %1$d символів.',
	),
	...
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Поле «%s» містить недопустимі символи, дозволені тількио буквено-цифрові символи і крапка (.).',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Поле «%s» містить недопустимі символи, дозволені тільки буквено-цифрові символи.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Поле «%s» містить недопустимі символи, дозволені тільки буквено-цифрові символи і  _,-. і перший символ повинен бути буквою.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Поле «%s» містить недопустимі символи, дозволені тільки буквено-цифрові символи, пробіли, а також символи -+_[].',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Поле «%s» містить недопустимі символи, only alphanumeric or _ characters are allowed.',
	'FIELD_INVALID_DATE'				=> 'Поле «%s» містить недопустиму дату.',
	'FIELD_INVALID_URL'					=> 'Поле «%s» містить недопустиму адресу url.',
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1  => '%2$d повідомлення із %1$s',
		2  => '%2$d повідомлення із %1$s',
		3  => '%2$d повідомлень із %1$s',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1  => 'Папка заповнена на %3$d%% (%2$d повідомлення із %1$s)',
		2  => 'Папка заповнена на %3$d%% (%2$d повідомлення із %1$s)',
		3  => 'Папка заповнена на %3$d%% (%2$d повідомлень із %1$s)',
	),
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Введіть email адресу, використаний для реєстрації облікового запису на сайті <a href="http://www.gravatar.com/">Граватар</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Розміри аватари',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Вкажіть ширину і висоту аватари. Залиште поля порожніми для автоматичного визначення розмірів.',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> 'Введіть посилання, за яким знаходиться файл із зображенням, він буде використаний у якості вашої аватари.',
	...
	'LOGIN_EXPLAIN_UCP'			=> 'Будь ласка, увійдіть, для входу у ваш Особистий розділ.',
	'LOGIN_LINK'					=> 'Зв\'язати обліковий запис зовнішнього сервісу з обліковим записом конференції або створити нову.',
	'LOGIN_LINK_EXPLAIN'			=> 'Ви спробували увійти за допомогою облікового запису іншого сервісу, яка поки не пов\'язана з обліковим записом конференції. Необхідно пов\'язати цей обліковий запис з існуючою або створити новий обліковий запис на конференції.',
	'LOGIN_LINK_MISSING_DATA'		=> 'Дані, необхідні для прив\'язки облікового запису конференції до облікового запису зовнішнього сервісу, недоступні. Повторіть процедуру авторизації.',
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Нt були надані дані для прив\'язки облікового запису зовнішнього сервісу до облікового запису конференції. Зв\'яжіться з адміністратором форуму, якщо проблема не зникне.',
	...
	'MAX_FOLDER_REACHED'			=> 'Досягнуто максимальну кількість папок користувачів.',
	'MESSAGE_BY_AUTHOR'				=> '',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Під час переміщення повідомлень в нову папку сталася помилка, перенесено повідомлень: %2$d із %1$d.',
		2	=> 'Під час переміщення повідомлень в нову папку сталася помилка, перенесено повідомлень: %2$d із %1$d.',
		3	=> 'Під час переміщення повідомлень в нову папку сталася помилка, перенесено повідомлень: %2$d із %1$d.',
	),
	'MOVE_TO_FOLDER'				=> 'Перемістити в папку',
	'MOVE_UP'						=> 'Перемістити вверх',

	'NEW_EMAIL_CONFIRM_EMPTY'		=> 'Ви не ввели підтвердження email адреси.',
	'NEW_EMAIL_ERROR'				=> 'Введені вами email адреси не збігаються.',
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Позначити всі повідомлення прочитаними',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Ви впевнені, що хочете позначити всі сповіщення прочитаними?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'Усі повідомлення відзначені як прочитані.',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1  => 'Папка з вашими приватними повідомленнями заповнена. У вас %d відкладене повідомлення',
		2  => 'Папка з вашими приватними повідомленнями заповнена. У вас %d відкладених повідомлення',
		3  => 'Папка з вашими приватними повідомленнями заповнена. У вас %d відкладених повідомлень',
	),
	...
	'NO_AUTH_EDIT_MESSAGE'			=> 'У вас немає доступу до редагування приватних повідомлень.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'У вас немає доступу до пересилання приватних повідомлень.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'У вас немає доступу до відправки приватних повідомлень у групи.',
	'NO_AUTH_PASSWORD_REMINDER'		=> 'У вас немає доступу до отримання нового пароля.',
	'NO_AUTH_PASSWORD_REMINDER'		=> 'У вас немає доступу до отримання нового пароля.',
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'У вас немає доступу до читання відкладених приватних повідомлень.',
	'NO_AUTH_READ_MESSAGE'			=> 'У вас немає доступу до читання приватних повідомлень.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Ви не можете прочитати це повідомлення, тому що воно було видалено його автором.',
	'NO_AUTH_SEND_MESSAGE'			=> 'У вас немає доступу до відправки приватних повідомлень.',
	...
	'NO_WATCHED_SELECTED'		=> 'Ви не обрали будь-які теми або форуми, на які підписані.',
	'NO_WATCHED_TOPICS'			=> 'Ви не підписані на які-небудь теми.',

	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Пароль повинен бути довжиною від %1$s до %2$s, містити букви різних регістрів і цифри.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Повинен бути довжиною від %1$s до %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Пароль повинен бути довжиною від %1$s до %2$s і містити букви різних регістрів.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Пароль повинен бути довжиною від %1$s до %2$s і містити букви різних регістрів, цифри й символи.',
	'PASSWORD'					=> 'Пароль',
	'PASSWORD_ACTIVATED'		=> 'Ваш новий пароль активовано.',
	'PASSWORD_UPDATED'			=> 'Новий пароль успішно відправлений на ваш реєстраційний email адресу.',
	...
	'PM_TO'						=> 'Кому',
	'PM_TOOLS'					=> 'Управління приватними повідомленнями',
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Деякі користувачі не можуть бути додані, так як у них відсутні права на читання приватних повідомлень.',
	'PM_USERS_REMOVED_NO_PM'	=> 'Деякі користувачі не можуть бути додані, так як вони відключили отримання приватних повідомлень.',
	'POST_EDIT_PM'				=> 'Редагувати',
	'POST_FORWARD_PM'			=> 'Переслати',
	'POST_NEW_PM'				=> 'Створити повідомлення',
	'POST_PM_LOCKED'			=> 'Приватні повідомлення заблоковані.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Ключі входу функції «Запам\'ятати мене» автоматично авторизують вас на конференції. Якщо ви вийшли з конференції, ключі входу видаляються тільки на тому комп\'ютері, який використано для виходу. Тут можна переглянути ключі для інших комп\'ютерів, які були використані вами для відвідування даної конференції.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Ключі входу функції «Запам\'ятати мене» відсутні.',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1  => 'Фільтрами ПП було видалено %d приватне повідомлення',
		2  => 'Фільтрами ПП було видалено %d приватних повідомлення',
		3  => 'Фільтрами ПП було видалено %d приватних повідомлень',
	),
	...
	'SELECT_CURRENT_TIME'		=> 'Вибрати поточний час',
	...
	'TIMEZONE_INVALID'			=> 'Вибрано неправильний часовий пояс.',
	'TO'						=> 'Одержувач',
	'TO_MASS'					=> 'Одержувач',
	'TO_ADD'					=> 'Добавити одержувача',
	'TO_ADD_MASS'				=> 'Добавити одержувачів',
	'TO_ADD_GROUPS'				=> 'Добавити групи',
	...
	'UCP_AUTH_LINK_ASK'			=> 'На даний момент відсутня обліковий запис, пов\'язана з обліковим записом на зовнішньому сервісі. Натисніть кнопку нижче, щоб зв\'язати свою обліковий запис з обліковим записом на зовнішньому сервісі.',
	...
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Прив\'язка облікових записів конференції до зовнішніх сервісів не підтримується поточним механізмом авторизації.',
	...
	'UCP_MAIN'					=> 'Огляд',
	'UCP_MAIN_ATTACHMENTS'		=> 'Вкладення',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Керування ключами входу для функції «Запам\'ятати мене»',

	'UCP_USERGROUPS'			=> 'Групи',
	'UCP_USERGROUPS_MEMBER'		=> 'Участь у групах',
	'UCP_USERGROUPS_MANAGE'		=> 'Управління групами',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'Функція відновлення пароля була відключена. Якщо вам потрібна допомога для доступу до вашого профілю, будь ласка, зв\'яжіться з %sАдміністратором конференції%s',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Ім\'я користувача має містити мінімум %1$d, максимум %2$d і має містити тільки букви.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Ім\'я користувача має містити мінімум %1$d, максимум %2$d і має містити тільки літери, пробіл або символи -+_[]',
	'USERNAME_ASCII_EXPLAIN'		=> 'Ім\'я користувача має містити мінімум %1$d, максимум %2$d і має містити тільки символи ASCII, без спеціальних символів.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Ім\'я користувача має містити мінімум %1$d, максимум %2$d і має містити тільки букви або цифри.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Ім\'я користувача має містити мінімум %1$d максимум %2$d знаків і має містити тільки букви, цифри, пробіл або символи -+_[]',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Ім\'я користувача має містити мінімум %1$d, максимум %2$d знаків.',
