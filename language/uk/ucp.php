...
$lang = array_merge($lang, array(
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'No data has been provided to this page to link an external account to a forum account. Зв\'яжіться з адміністратором конференції, якщо проблема повториться.',
