...
$lang = array_merge($lang, array(
	...
	'ACL_M_BAN'		=> 'Може керувати блокуванням<br /><em>Це право може бути призначено лише глобально, а не на рівні форумів.</em>', // This moderator setting is only global (and not local)
));
...
$lang = array_merge($lang, array(
	...
	'ACL_A_USER'		=> 'Може керувати користувачами<br /><em>Право також включає перегляд типу браузера користувачів у списку знаходяться на конференції.</em>',
	...
	'ACL_A_BAN'			=> 'Може керувати блокуванням',
	...
	'ACL_A_SEARCH'		=> 'Може керувати пошуковими індексами/установками пошуку',
));
