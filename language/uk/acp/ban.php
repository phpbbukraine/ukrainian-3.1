...
$lang = array_merge($lang, array(
	...
	'EMAIL_BAN_EXPLAIN'			=> 'Вводите кожну адресу на новому рядку. Використовуйте зірочку (*) як символи узагальнення для блокування групи однотипних адрес. Наприклад, <samp>*@gmail.com</samp>, <samp>*@*.domain.tld</samp> і т. д.',
	...
	'IP_UNBAN'					=> 'Розблокувати доступ з IP-адреси або видалити адреси з білого списку',
	...
	'UNTIL'						=> 'До дати',
	'USER_BAN'					=> 'Заблокувати доступ по імені користувача',
	...
	'USER_UNBAN'				=> 'Розблокувати доступ або видалити ім\'я користувача з білого списку',
