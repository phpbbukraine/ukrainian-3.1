...
$lang = array_merge($lang, array(
	...
	'CANNOT_REMOVE_FOUNDER'			=> 'Ви не можете видалити обліковий запис засновника.',
	...
	'USER_ADMIN_BAN_EMAIL'			=> 'Заборонити email-адресу',
	'USER_ADMIN_BAN_EMAIL_REASON'	=> 'Email-адреси, заборонені через управління користувачами',
	'USER_ADMIN_BAN_IP'				=> 'Заборонити IP-адресу',
	...
	'USER_ADMIN_EXPLAIN'			=> 'Тут ви можете змінювати інформацію про користувачів і деякі спеціальні налаштування.',
	...
	'USER_ATTACHMENTS_REMOVED'		=> 'Всі вкладення даного користувача успішно видалено.',
	...
	'USER_NO_ATTACHMENTS'			=> 'Вкладення відсутні.',
	...
	'USER_POSTS_MOVED'				=> 'Повідомлення користувача успішно переміщені у вказаний форум.',
