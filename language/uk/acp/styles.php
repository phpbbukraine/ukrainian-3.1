...
$lang = array_merge($lang, array(
	...
	'STYLE_INSTALLED_EDIT_DETAILS'	=> '<a href="%s">Нажміть сюди</a> для редагування інформації про стиль або зміни стилю за замовчуванням.',
	'STYLE_INSTALLED_RETURN_STYLES'	=> '<a href="%s">Нажміть сюди</a> для повернення до списку встановлених стилів.',
	'STYLE_INSTALLED_RETURN_UNINSTALLED'	=> '<a href="%s">Нажміть сюди</a> для повернення до встановлення інших стилів.',
