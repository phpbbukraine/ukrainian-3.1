...
$lang = array_merge($lang, array(
	...
	'ACP_MANAGE_ATTACHMENTS'			=> 'Управління додатковими файлами',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Тут можна переглядати і видаляти вкладення, прикріплені до повідомлень у темах і особистим повідомленнями.',
