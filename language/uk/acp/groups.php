...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'За допомогою цієї панелі ви можете керувати всіма групами користувачів. Ви можете видаляти їх, створювати нові і редагувати існуючі. Крім цього, ви можете призначати лідерів, змінювати відкритий/прихований/закритий статус груп, а також задавати назви та описи груп.',
