...
$lang = array_merge($lang, array(
	...
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'Тут ви можете керувати дозволеними розширеннями. Для активації розширень відвідайте сторінку «Групи розширень». Ми наполегливо рекомендуємо не дозволяти потенційно небезпечні розширення (такі, як <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code> і так далі…).',
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Тут ви можете бачити втрачені файли. Зазвичай такі файли з\'являються через те, що користувачі прикріплюють файли, але згодом не публікують повідомлення. Ви можете видалити такі файли або прикріпити їх до існуючих повідомленнями. У другому випадку вам буде потрібно правильний ідентифікатор повідомлення (ID), який ви повинні вказати самостійно. Після цього завантаження вкладення буде прикріплено до вказаного вами повідомленням.',
	...
	'ATTACH_ORPHAN_URL'					=> 'Втрачені вкладення',
	'ATTACH_POST_ID'					=> 'ID повідомлення',
	'ATTACH_POST_TYPE'					=> 'Тип повідомлення',
	'ATTACH_QUOTA'						=> 'Загальна квота вкладень',
	'ATTACH_QUOTA_EXPLAIN'				=> 'Максимально доступний дисковий простір для кладень. Значення 0 відповідає необмеженому розміром.',
	...
	'CHECK_CONTENT'				=> 'Перевіряти вкладення',
	'CHECK_CONTENT_EXPLAIN'		=> 'Деякі браузери можуть бути обмануті при визначенні MIME-типу завантажуваних файлів. Включення цієї опції гарантує, що такі файли, наймовірніше, будуть відхилятися під час завантаження.',
	...
	'DEFINE_ALLOWED_IPS'			=> 'Дозволені IP-адреси і вузли',
	'DEFINE_DISALLOWED_IPS'			=> 'Заборонені IP-адреси і вузли',
	...
	'EXCLUDE_FROM_ALLOWED_IP'		=> 'Виключити IP-адресу з дозволених',
	...
	'EXTENSION_GROUP_DELETED'		=> 'Група розширень успішно видалена.',
	...
	'MAX_ATTACHMENTS'				=> 'Максимум вкладень в одному повідомленні',
	'MAX_ATTACHMENTS_PM'			=> 'Максимум вкладень в приватному повідомленні',
	...
	'MAX_THUMB_WIDTH_EXPLAIN'		=> 'Ширина створюваних мініатюр не перевищуватиме вказаного тут розміру.',
	'MIN_THUMB_FILESIZE'			=> 'Мінімальний розмір файлів для мініатюр',
	'MIN_THUMB_FILESIZE_EXPLAIN'	=> 'Мініатюри не створюватимуться для малюнків менше вказаного розміру.',
	'MODE_INLINE'					=> 'Inline',
	...
	'ONLY_ALLOWED_IN_PM'	=> 'Група розширень дозволена тільки в приватних повідомленнях',
	...
	'SPECIAL_CATEGORY_EXPLAIN'		=> 'Спеціальні категорії відрізняються способом відображення вкладень в повідомленнях.',
	'SUCCESSFULLY_UPLOADED'			=> 'Завантаження успішно завершено.',
	'SUCCESS_EXTENSION_GROUP_ADD'	=> 'Група розширень успішно додана.',
	...
	'UPLOAD_DENIED_FORUM'			=> 'У вас немає прав на завантаження файлів в форум «%s».',
	'UPLOAD_DIR'					=> 'Папка для зберігання вкладень',
	...
	'UPLOAD_ICON'					=> 'Значок вкладення',
	'UPLOAD_NOT_DIR'				=> 'Вказаний шлях для завантаження файлів не є папкою.',
));
