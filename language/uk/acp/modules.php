...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Тут ви можете керувати всіма типами модулів. Зверніть увагу на те, що панелі адміністратора має трирівневу структуру меню (Категорія → Категорія → Модуль), в результаті чого підрозділи мають дворівневу структуру меню (Категорія → Модуль), яка повинна бути збережена. Також врахуйте, що ви можете заблокувати доступ самому собі, якщо ви вимкніть або видаліть модулі, що відповідають за управління модулями.',
